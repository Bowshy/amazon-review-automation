<script lang="ts">
	...
	export let onrunAutomation: (() => void) | undefined = undefined;
	export let onretryFailed: (() => void) | undefined = undefined;
	export let onsyncOrders: (() => void) | undefined = undefined;
	export let oncheckSolicitation: ((orderId: string) => void) | undefined = undefined;
	export let ontriggerReview: ((orderId: string) => void) | undefined = undefined;
	export let onsort: ((detail: { sortBy: string; sortOrder: 'asc' | 'desc' }) => void) | undefined = undefined;
	export let onpageChange: ((detail: { page: number }) => void) | undefined = undefined;
	export let onfilterChange: ((detail: { filters: Record<string, any> }) => void) | undefined = undefined;
...
<div class="space-y-8">
	...
	{#if stats}
		...
		<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
			<div class="rounded-lg bg-white p-6 shadow">
				<h3 class="mb-4 text-lg font-medium text-gray-900">Review Request Status</h3>
				<div class="space-y-3">
		...
		<div class="rounded-lg bg-white p-6 shadow">
			...
			<div class="grid grid-cols-1 gap-3 md:grid-cols-3">
				...
				<button
					...
					class="rounded-lg bg-green-600 px-4 py-2 text-sm text-white transition-colors hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-50"
				>
				...
				<button
					...
					class="rounded-lg bg-purple-600 px-4 py-2 text-sm text-white transition-colors hover:bg-purple-700 disabled:cursor-not-allowed disabled:opacity-50"
				>
